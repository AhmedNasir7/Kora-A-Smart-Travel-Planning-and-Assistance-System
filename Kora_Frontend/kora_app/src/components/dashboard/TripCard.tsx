...
export function TripCard({
  ...
  return (
    <div className="bg-gradient-to-br from-[#1A1D26] to-[#13151A] border border-[#2A2D35] rounded-2xl p-8 hover:border-[#FF7B54] transition-all duration-300 group shadow-lg hover:shadow-2xl hover:shadow-[#FF7B54]/10 hover:scale-102 min-h-40">
